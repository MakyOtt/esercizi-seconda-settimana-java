...
public class Esercizion5{
    ...
    public static void exercise3() {
        ...
        System.out.println(oggi.getDayOfYear());
        System.out.println(oggi.getMonth());
        System.out.println(oggi.getMonthValue());
        LocalDate nuovaData;
        try {
            nuovaData= LocalDate.of(1995,05,24);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        System.out.println(oggi.isBefore(nuovaData));
        System.out.println(oggi.isAfter(nuovaData));
